...
dropdownFrame.BackgroundColor3 = Color3.fromRGB(32, 37, 49)
...
dropdownTextButton.Position = UDim2.new(0.895, 0, 0, 0)
dropdownTextButton.Size = UDim2.new(0, 18, 0, 24)
dropdownTextButton.Parent = dropdownFrame

local dropdownSearch = Instance.new("TextBox")
dropdownSearch.Name = "DropdownSearch"
dropdownSearch.CursorPosition = -1
dropdownSearch.Font = Enum.Font.GothamBold
dropdownSearch.PlaceholderColor3 = Color3.fromRGB(232, 232, 232)
dropdownSearch.Text = Info.Default or "Search"
dropdownSearch.TextColor3 = Color3.fromRGB(232, 232, 232)
...
dropdownSearch.Position = UDim2.new(0.0234, 0, 0, 0)
dropdownSearch.Size = UDim2.new(0, 147, 0, 24)
...
if Info.Default then
    ...
    if Info.ChangeTextOnPick then
        dropdownSearch.Text = Info.Default
    end
end
...
function insidedropdown:Toggle(bool)
    ...
    TweenService:Create(section, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = bool and UDim2.new(0, 175, 0, section.Size.Y.Offset + (DropdownY)) or UDim2.new(0, 175, 0, section.Size.Y.Offset - (DropdownY))}):Play()
    TweenService:Create(sectionFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = bool and UDim2.new(0, 175, 0, sectionFrame.Size.Y.Offset + (DropdownY)) or UDim2.new(0, 175, 0, sectionFrame.Size.Y.Offset - (DropdownY))}):Play()
    TweenService:Create(itemContainer, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = bool and UDim2.new(0, 175, 0, itemContainer.Size.Y.Offset + (DropdownY)) or UDim2.new(0, 175, 0, itemContainer.Size.Y.Offset - (DropdownY))}):Play()
    TweenService:Create(dropdown, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = bool and UDim2.new(0, 175, 0, DropdownY + 28) or UDim2.new(0, 175, 0, 28)}):Play()
    TweenService:Create(dropdownFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = bool and UDim2.new(0, 171, 0, DropdownY + 24) or UDim2.new(0, 171, 0, 24)}):Play()
    TweenService:Create(dropdownContainer, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = bool and UDim2.new(0, 171, 0, DropdownY) or UDim2.new(0, 171, 0, 0)}):Play()
    TweenService:Create(dropdownIcon, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Rotation = bool and -90 or 90}):Play()
...
dropdownElementButton.MouseButton1Click:Connect(function()
    ...
    if Info.ChangeTextOnPick then
        dropdownSearch.Text = dropdownElementText.Text
    end
...
dropdownSearch:GetPropertyChangedSignal("Text"):Connect(function()
    if DropdownOpened and dropdownSearch.Text ~= "" then
        for _, v in pairs(dropdownContainer:GetChildren()) do
            if v.ClassName == "Frame" then
                local ElementText = v.dropdownElementText.Text

                if string.find(dropdownSearch.Text, ElementText) then
                    v.Visible = true
                    if not v.Visible then
                        v.Visible = true
                        section.Size = UDim2.new(0, 175, 0, section.Size.Y.Offset + 24)
                        sectionFrame.Size = UDim2.new(0, 175, 0, sectionFrame.Size.Y.Offset + 24)
                        itemContainer.Size = UDim2.new(0, 175, 0, itemContainer.Size.Y.Offset + 24)
                        dropdown.Size = UDim2.new(0, 175, 0, dropdown.Size.Y.Offset + 24)
                        dropdownFrame.Size = UDim2.new(0, 175, 0, dropdownFrame.Size.Y.Offset + 24)
                        dropdownContainer.Size = UDim2.new(0, 175, 0, dropdownContainer.Size.Y.Offset + 24)
                    end
                else
                    if v.Visible then
                    v.Visible = false
